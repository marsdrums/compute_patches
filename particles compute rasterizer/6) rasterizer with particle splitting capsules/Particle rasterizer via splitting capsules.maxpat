        ...
        "boxes": [
            {
                "box": {
                    ...
                    "numoutlets": 2,
                    "outlettype": [ "", "" ],
                    "patching_rect": [ 507.0, 393.0, 416.0, 22.0 ],
                    "text": "jit.gpu.image @dim 500 500 @format RGBA32_FLOAT @name prevPosImg"
                }
            },
            {
                "box": {
            ...
            },
            {
                "box": {
                    ...
                    "patching_rect": [ 206.0, 515.0, 72.0, 22.0 ],
                    "text": "p fps_meter"
                }
            },
            {
                "box": {
                    ...
                    "outlettype": [ "", "bang" ],
                    "parameter_enable": 0,
                    "patching_rect": [ 206.0, 591.0, 323.0, 73.0 ]
                }
            },
            {
                "box": {
            ...
            },
            {
                "box": {
                    ...
                    "text": "jit.gpu.compute @name copyOriginalPosition @file copyOriginalPosition.jxs @threads 16 16 1 @automatic 0 @posImg posImg @originalPosImg originalPosImg @depends_on clearGrid",
                    "textfile": {
                        "filename": "copyOriginalPosition.jxs",
                        "flags": 0,
                        "embed": 0,
            ...
            },
            {
                "box": {
                    ...
                    "numoutlets": 2,
                    "outlettype": [ "jit_matrix", "" ],
                    "patching_rect": [ 469.0, 301.0, 149.0, 22.0 ],
            ...
            },
            {
                "box": {
                    ...
                    "numoutlets": 2,
                    "outlettype": [ "", "" ],
                    "patching_rect": [ 537.0, 255.0, 431.0, 22.0 ],
                    "text": "jit.gpu.image @dim 500 500 @format RGBA32_FLOAT @name originalPosImg"
                }
            },
            {
                "box": {
            ...
            },
            {
                "box": {
                    ...
                    "numoutlets": 2,
                    "outlettype": [ "jit_matrix", "" ],
                    "patching_rect": [ 535.0, 123.0, 168.0, 22.0 ],
                    "text": "jit.scanwrap 3 float32 500 500"
                }
            },
            {
                "box": {
            ...
            },
            {
                "box": {
                    ...
                    "numoutlets": 2,
                    "outlettype": [ "", "" ],
                    "patching_rect": [ 456.0, 353.0, 391.0, 22.0 ],
                    "text": "jit.gpu.image @dim 500 500 @format RGBA32_FLOAT @name posImg"
                }
            },
            {
                "box": {
            ...
            },
            {
                "box": {
                    ...
                    "text": "jit.gpu.compute @file renderParticleAtomics.jxs @threads 16 16 1 @grid grid @posImg posImg @prevPosImg prevPosImg @automatic 0 @depends_on copyOriginalPosition @name renderParticle",
                    "textfile": {
                        "filename": "renderParticleAtomics.jxs",
                        "flags": 0,
                        "embed": 0,

    ...
    "patcher": {
        ...
        "boxes": [
            {
                "box": {
                    ...
                    "patching_rect": [ -188.0, 1056.0, 44.0, 22.0 ],
                    "text": "sel 1 0"
                }
            },
            {
                "box": {
                    ...
                    "numoutlets": 1,
                    "outlettype": [ "int" ],
                    "patching_rect": [ -188.0, 1020.0, 29.5, 22.0 ],
                    "text": "<"
                }
            },
            {
                "box": {
                    ...
                    "numoutlets": 1,
                    "outlettype": [ "int" ],
                    "patching_rect": [ -188.0, 973.0, 29.5, 22.0 ],
                    "text": "int"
                }
            },
            {
                "box": {
                    ...
                    "patching_rect": [ -209.0, 768.0, 50.5, 22.0 ],
                    "text": "t b i b i"
                }
            },
            {
                "box": {
                    ...
                    "patching_rect": [ -209.0, 684.0, 61.0, 22.0 ],
                    "text": "t b 0 b"
                }
            },
            {
                "box": {
                    ...
                    "numoutlets": 4,
                    "outlettype": [ "int", "", "", "int" ],
                    "patching_rect": [ -209.0, 732.5, 61.0, 22.0 ],
                    "text": "counter"
                }
            },
            {
            ...
            },
            {
                "box": {
                    ...
                    "numoutlets": 2,
                    "outlettype": [ "", "" ],
                    "patching_rect": [ 762.0, 389.0, 196.0, 22.0 ],
            ...
            },
            {
                "box": {
                    ...
                    "numoutlets": 2,
                    "outlettype": [ "", "" ],
                    "patching_rect": [ 762.0, 358.0, 196.0, 22.0 ],
                    "text": "jit.gpu.image @format rgba32_float"
                }
            },
            {
                "box": {
                    ...
                    "numoutlets": 2,
                    "outlettype": [ "", "" ],
                    "patching_rect": [ 762.0, 328.0, 196.0, 22.0 ],
                    "text": "jit.gpu.image @format rgba32_float"
                }
            },
            {
            ...
            },
            {
                "box": {
                    ...
                    "numoutlets": 1,
                    "outlettype": [ "" ],
                    "patching_rect": [ 1114.0, 328.0, 66.0, 22.0 ],
                    "text": "gimme $1"
                }
            },
            {
                "box": {
                    ...
                    "numoutlets": 1,
                    "outlettype": [ "" ],
                    "patching_rect": [ 1114.0, 353.0, 90.0, 22.0 ],
            ...
            },
            {
                "box": {
                    ...
                    "textfile": {
                        "text": "#version 460\n\nstruct m3{\n    vec4 mm;   \n    vec4 accum; \n    vec4 MM;  \n};\n\nlayout(rgba32f, binding = 0) uniform image1D mmImg;\nlayout(rgba32f, binding = 1) uniform image1D accumImg;\nlayout(rgba32f, binding = 2) uniform image1D MMImg;\n\nlayout(rgba32f, binding = 3) uniform writeonly image2D outmmImg;\nlayout(rgba32f, binding = 4) uniform writeonly image2D outaccumImg;\nlayout(rgba32f, binding = 5) uniform writeonly image2D outMMImg;\n\nlayout(binding = 6) uniform Cfg {\n    uint writeOffset;\n    float invPixelCount;\n}cfg;\n\nlayout(local_size_x = 1) in;\n\nvoid main() {\n\n    vec4 mm = imageLoad(mmImg, int(cfg.writeOffset));\n    vec4 sum = imageLoad(accumImg, int(cfg.writeOffset));\n    vec4 MM = imageLoad(MMImg, int(cfg.writeOffset));\n\n    // i use the last write offset as reading offset\n    imageStore(outmmImg,   ivec2(0), mm);\n    imageStore(outaccumImg, ivec2(0), sum*cfg.invPixelCount);\n    imageStore(outMMImg,   ivec2(0), MM);\n}",
                        "filename": "none",
                        "flags": 0,
                        "embed": 1,
                        "autowatch": 1
            ...
            },
            {
                "box": {
                    ...
                    "numoutlets": 1,
                    "outlettype": [ "" ],
                    "patching_rect": [ 311.0, 498.0, 75.0, 22.0 ],
                    "text": "prepend dim"
                }
            },
            {
        ...
        "lines": [
            ...
            },
            {
                "patchline": {
                    "destination": [ "obj-42", 0 ],
                    "midpoints": [ -178.5, 1103.0, -241.2421875, 1103.0, -241.2421875, 722.5, -199.5, 722.5 ],
                    "source": [ "obj-87", 0 ]
                }
            },
            {

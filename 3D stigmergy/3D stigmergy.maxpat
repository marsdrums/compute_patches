...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 623.0, 804.0, 245.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 30.0, 306.0, 47.0, 22.0 ],
					"text" : "jit.bang"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 600.0, 654.0, 24.0, 24.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "jit_matrix", "" ],
					"patching_rect" : [ 604.0, 705.0, 145.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 113.0, 707.0, 58.0, 22.0 ],
					"text" : "loadbang"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 113.0, 742.0, 238.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "jit_matrix", "" ],
					"patching_rect" : [ 113.0, 780.0, 123.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 771.0, 658.0, 58.0, 22.0 ],
					"text" : "loadbang"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 771.0, 693.0, 207.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "jit_matrix", "" ],
					"patching_rect" : [ 771.0, 731.0, 149.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "jit_gl_buffer", "" ],
					"patching_rect" : [ 771.0, 769.0, 239.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 228.0, 561.0, 463.0, 22.0 ],
					"text" : "jit.gpu.compute @readwrite field @shader diffuseD @threads 64 64 64 @automatic 0",
...
, 			{
				"box" : 				{
					"filename" : "diffuseD.comp",
					"id" : "obj-59",
					"maxclass" : "newobj",
					"numinlets" : 0,
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 855.0, 566.0, 284.0, 22.0 ],
					"text" : "jit.gpu.shader @name diffuseD @file diffuseD.comp",
					"textfile" : 					{
						"filename" : "diffuseD.comp",
						"flags" : 0,
						"embed" : 0,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 228.055576682090759, 513.0, 462.0, 22.0 ],
					"text" : "jit.gpu.compute @readwrite field @shader diffuseV @threads 64 64 64 @automatic 0",
...
, 			{
				"box" : 				{
					"filename" : "diffuseV.comp",
					"id" : "obj-57",
					"maxclass" : "newobj",
					"numinlets" : 0,
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 855.055576682090759, 518.0, 281.0, 22.0 ],
					"text" : "jit.gpu.shader @name diffuseV @file diffuseV.comp",
					"textfile" : 					{
						"filename" : "diffuseV.comp",
						"flags" : 0,
						"embed" : 0,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 848.0, 344.0, 324.0, 22.0 ],
					"text" : "jit.gpu.shader @name spreadFood @file spreadFood.comp",
					"textfile" : 					{
						"filename" : "spreadFood.comp",
						"flags" : 0,
						"embed" : 0,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 30.0, 344.0, 566.0, 22.0 ],
					"text" : "jit.gpu.compute @readwrite field @read modelBuff @shader spreadFood @threads 79 1 1 @automatic 0",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "jit_matrix", "" ],
					"patching_rect" : [ 55.0, 1233.0, 149.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 228.055576682090759, 461.0, 463.0, 22.0 ],
					"text" : "jit.gpu.compute @readwrite field @shader diffuseH @threads 64 64 64 @automatic 0",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 356.0, 693.0, 171.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 356.0, 651.0, 182.0, 22.0 ],
					"text" : "jit.gpu.totexture @source outImg"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 55.0, 1284.0, 398.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 304.0, 48.0, 80.0, 22.0 ],
					"text" : "loadmess 0.1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 208.0, 48.0, 87.0, 22.0 ],
					"text" : "loadmess 0.03"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 111.0, 48.0, 87.0, 22.0 ],
					"text" : "loadmess 0.01"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 30.0, 48.0, 70.0, 22.0 ],
					"text" : "loadmess 2"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 30.0, 197.0, 61.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 29.861112534999847, 227.777788639068604, 268.0, 22.0 ],
					"text" : "jit.gpu.constants @name Config @bindas Config"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 208.0, 89.0, 50.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 121.333333333333314, 89.0, 50.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 30.0, 89.0, 50.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 30.0, 136.0, 293.0, 22.0 ],
					"text" : "pak 4. 0.01 1. 1."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 30.0, 165.0, 387.0, 22.0 ],
					"text" : "set frontness $1, set speed $2, set radius $3, set randomness $4, bang"
				}

			}
, 			{
				"box" : 				{
					"filename" : "diffuseH.comp",
					"id" : "obj-19",
					"maxclass" : "newobj",
					"numinlets" : 0,
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 855.055576682090759, 466.0, 284.0, 22.0 ],
					"text" : "jit.gpu.shader @name diffuseH @file diffuseH.comp",
					"textfile" : 					{
						"filename" : "diffuseH.comp",
						"flags" : 0,
						"embed" : 0,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "jit_matrix", "" ],
					"patching_rect" : [ 91.0, 1165.0, 153.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "jit_matrix", "" ],
					"patching_rect" : [ 113.0, 1095.0, 140.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "jit_matrix", "" ],
					"patching_rect" : [ 113.0, 1055.0, 152.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 113.0, 1130.0, 287.0, 22.0 ],
					"text" : "jit.gpu.buffer @name agentVel @item_count 490000"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 443.055576682090759, 183.3333420753479, 24.0, 24.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 468.055577874183655, 183.3333420753479, 24.0, 24.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 443.055576682090759, 227.777788639068604, 232.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 91.0, 947.0, 58.0, 22.0 ],
					"text" : "loadbang"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 91.0, 981.0, 24.0, 24.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "jit_matrix", "" ],
					"patching_rect" : [ 91.0, 1021.0, 152.0, 22.0 ],
					"text" : "jit.noise 4 float32 490000 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "jit_matrix", "" ],
					"patching_rect" : [ 17.0, 1322.0, 173.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 848.0, 407.0, 355.0, 22.0 ],
					"text" : "jit.gpu.shader @name updatePosition @file updatePosition.comp",
					"textfile" : 					{
						"filename" : "updatePosition.comp",
						"flags" : 0,
						"embed" : 0,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 91.0, 1202.0, 291.0, 22.0 ],
					"text" : "jit.gpu.buffer @name agentPos @item_count 490000"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 30.0, 407.0, 761.0, 22.0 ],
					"text" : "jit.gpu.compute @readwrite field agentPos agentVel @write outImg @read Config @shader updatePosition @threads 1915 1 1 @automatic 0",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 17.0, 1356.0, 448.0, 22.0 ],
					"text" : "jit.gpu.image @name field @dim 512 512 512 @format R32_FLOAT @bindas field"
				}
...
, 			{
				"name" : "jit.geom.distribute.mxo",
				"type" : "iLaX"
			}
, 			{
				"name" : "jit.geom.normalize.mxo",
				"type" : "iLaX"
			}
, 			{

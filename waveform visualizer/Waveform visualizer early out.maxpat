        ...
        "boxes": [
            {
                "box": {
                    ...
                    "parameter_enable": 0,
                    "patching_rect": [ 392.0, 47.0, 150.0, 30.0 ],
                    "quality": "basic",
            ...
            },
            {
                "box": {
                    ...
                    "numoutlets": 1,
                    "outlettype": [ "signal" ],
                    "patching_rect": [ 340.0, 91.0, 66.0, 22.0 ],
                    "text": "cycle~ 500"
                }
            },
            {
                "box": {
                    ...
                    "patching_rect": [ 234.0, 445.0, 297.0, 22.0 ],
                    "text": "jit.world @enable 1 @displaylink 0 @fps 400 @sync 0"
                }
            },
            {
                "box": {
            ...
            },
            {
                "box": {
                    ...
                    "patching_rect": [ 30.0, 384.0, 368.0, 22.0 ],
